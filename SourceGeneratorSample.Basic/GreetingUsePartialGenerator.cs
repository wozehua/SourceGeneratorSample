...
public sealed class GreetingUsePartialGenerator : ISourceGenerator
{
    ...
    partial class GreetingUsePartialClass
    {
        ...
        public static partial void SayHelloTo(string name)=>global::System.Console.WriteLine($"Hello,{name}!");
    }    
